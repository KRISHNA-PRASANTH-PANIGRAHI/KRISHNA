...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? Auth2CreateWidget() : HomeWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: GameCodeWidget.routeName,
          path: GameCodeWidget.routePath,
          builder: (context, params) => GameCodeWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CartProductDetailsWidget.routeName,
          path: CartProductDetailsWidget.routePath,
          asyncParams: {
        ...
        FFRoute(
          name: CartDetailsWidget.routeName,
          path: CartDetailsWidget.routePath,
          builder: (context, params) => CartDetailsWidget(),
        ),
        FFRoute(
          name: CartOrderDetailsWidget.routeName,
          path: CartOrderDetailsWidget.routePath,
          asyncParams: {
            'orderRef': getDocList(['orders'], OrdersRecord.fromSnapshot),
          },
          builder: (context, params) => CartOrderDetailsWidget(
            orderRef: params.getParam<OrdersRecord>(
              'orderRef',
              ParamType.Document,
              isList: true,
            ),
        ...
        FFRoute(
          name: CartOrderHistoryWidget.routeName,
          path: CartOrderHistoryWidget.routePath,
        ...
        FFRoute(
          name: CartSuccessPageWidget.routeName,
          path: CartSuccessPageWidget.routePath,
