...
class NotificationCreateWidget extends StatefulWidget {
  const NotificationCreateWidget({
    super.key,
  ...
  static String routeName = 'notification_Create';
  static String routePath = '/notificationCreate';
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 16.0, 0.0),
                            child: Text(
                              'You can fill out the elements below to create an activity item.',
                              style: FlutterFlowTheme.of(context)
                                  .labelLarge
                                  .override(
                                    fontFamily: 'Inter',
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    options: [
                                      ChipData('General', Icons.add_link_sharp),
                                      ChipData('Clubs'),
                                      ChipData('Events'),
                                      ChipData('Curriculum')
                                    ],
