...
class CartOrderDetailsWidget extends StatefulWidget {
  ...
  /// cart
  final List<OrdersRecord>? orderRef;

  final DocumentReference? product;

  static String routeName = 'cart_OrderDetails';
  static String routePath = '/cartOrderDetails';

  @override
  State<CartOrderDetailsWidget> createState() => _CartOrderDetailsWidgetState();
}

class _CartOrderDetailsWidgetState extends State<CartOrderDetailsWidget> {
  late CartOrderDetailsModel _model;
